...
- (void)viewDidLoad {
    ...
    [self addImageWithName:@"specialEffects_example_mirrImage" text:@"Animated GIF"];
    [self addImageWithName:@"specialEffects_example_rain" text:@"Animated WebP"];
    [self addImageWithName:@"specialEffects_example_shake" text:@"Animated PNG (APNG)"];
    [self addImageWithName:@"specialEffects_example_soulOut" text:@"Animated PNG (APNG)"];
    [self addImageWithName:@"specialEffects_example_oldTV" text:@"Animated PNG (APNG)"];

    //    [self addFrameImageWithText:@"specialEffects_example_soulOut"];
